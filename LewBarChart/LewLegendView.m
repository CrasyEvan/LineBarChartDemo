    ...
    switch (_alignment) {
        case LegendAlignmentVertical:{
            CGRect bounds = CGRectMake(0, 0,
                                       Margin+RectWidth+Rect_TextMargin+textMaxWidth+Margin,
                                       Margin+(LegendTextSize+LegendMargin)*data.count-LegendMargin+Margin);
            self.bounds = bounds;
            break;
        }
        case LegendAlignmentHorizontal:{
            CGRect bounds = CGRectMake(0, 0,
                                       Margin+(RectWidth+Rect_TextMargin+LegendMargin)*data.count+textWidth-LegendMargin+Margin,
                                       Margin+LegendTextSize+Margin);
            self.bounds = bounds;
            break;
        }
    }
    ...
    switch (_alignment) {
        case LegendAlignmentVertical:{
            [_data enumerateObjectsUsingBlock:^(LewLegendViewData * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                CGRect rect = CGRectMake(Margin ,Margin+idx*(LegendTextSize+LegendMargin)+(LegendTextSize-RectWidth)/2,
                                         RectWidth, RectWidth);//坐标
                CGContextFillRect(context, rect);
                
                [obj.label drawInRect:CGRectMake(Margin+RectWidth+Rect_TextMargin,
                                                 Margin+idx*(LegendTextSize+LegendMargin)-2,
                                                 self.bounds.size.width, LegendTextSize*2) withAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:LegendTextSize], NSForegroundColorAttributeName:[UIColor grayColor]}];
            }];
            break;
        }
        case LegendAlignmentHorizontal:{
            ...
            [_data enumerateObjectsUsingBlock:^(LewLegendViewData * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                [obj.label drawInRect:CGRectMake(x, Margin-2, size.width, self.bounds.size.height)
                       withAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:LegendTextSize], NSForegroundColorAttributeName:[UIColor grayColor]}];
